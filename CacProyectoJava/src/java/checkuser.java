...
public class checkuser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            while(rs.next()){
                out.println("El usuario registrado es:");
                out.println(rs.getString("usuario"));
                out.println(", y su nombre y apellido es:");
            ...
            if(rs.first()==false){
                ...
                out.println("<h2>No existe el usuario: " + request.getParameter("inputEmail") + " o la contraseña es incorrecta." + "</h2>");
            }
